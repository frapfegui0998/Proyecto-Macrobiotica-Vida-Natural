<x-admin-layout>
    ...
    <body class="antialiased font-sans bg-gray-200">
        <div class="container mx-auto px-4 sm:px-8">
            ...
            <div class="py-8">
                <div>
                    <h2 class="text-2xl font-semibold leading-tight mb-4 text-white">Productos</h2>
                </div>
                <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                    <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                        <a href="{{ route('admin.products.create') }}"><button
                                class="group relative h-10 w-28 overflow-hidden rounded-2xl bg-gray-400 text-lg font-bold text-white btn btn-primary" style="margin-bottom: 15px;">
                                Nuevo
                                <div
