...
<link rel="stylesheet" href="icomoon.ttf">
<link rel="stylesheet" href="icomoon.woff">
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <nav class="site-navigation text-right text-md-center" role="navigation">
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                        ...
                        <li><a href="indexlogin.blade.php">Salir</a></li>
                    </ul>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="feature">
                    ...
                    <p>Informese.</p>
                    <p><a href="shop.blade.php" class="d-flex align-items-center"><span class="mr-2">Saber mas</span> <span class="icon-keyboard_arrow_right"></span></a></p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="feature">
                    <span class="wrap-icon flaticon-test-tubes"></span>
                    <h3><a href="shop.blade.php">Resultados Garantizados</a></h3>
        ...
        <div class="row">
            <div class="col-md-12 block-3 Productos-wrap">
                <div class="nonloop-block-3 owl-carousel">
                    ...
                    <div class="text-center item mb-4 item-v2">
                        <a href="shop.blade.php"> <img src="images/product_04.png" alt="Image"></a>
                        <h3 class="text-dark"><a href="shop.blade.php">Umcka Cold Care</a></h3>
