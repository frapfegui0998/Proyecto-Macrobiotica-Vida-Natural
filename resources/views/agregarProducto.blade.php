            ...
            <div class='dashboard-content'>
                <div class='container'>
                    ...
                    <div style="text-align: left">
                        <a href="dashInventario.blade.php" class="btn btn-primary">Regresar</a>
                    </div>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class='card-body'>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 margin-bottom-15">
                                        <label for="lblNombre" class="control-label">Descripcion</label>
                                        <input type="text" class="form-control" id="txtNombre" name="txtNombre">
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                        <div class="col-6 .col-md-4">
                                            <label for="lblNombre" class="control-label">Fecha De Vencimiento</label>
                                            <input type="text" style="width: 90%;" class="form-control" id="txtPrecio" name="txtPrecio">
