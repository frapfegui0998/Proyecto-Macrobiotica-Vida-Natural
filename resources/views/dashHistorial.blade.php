             ...
             <div class='dashboard-content'>
                 <div class='container'>
                     <div class='card'>
                         ...
                         <br>
                         <a href="AgregarHistorial.blade.php" class="btn btn-primary px-5 py-3" style="width: 20%; margin-left:40%; margin-top: 10px; margin-bottom: 10px;">Agregar Historial</a>
                         <a href="EditarHistorial.blade.php" class="btn btn-primary px-5 py-3" style="width: 20%; margin-left:40%; margin-top: 10px; margin-bottom: 10px;">Editar Historial</a>
                         <div class='card-body'>
                    ...
                    <div class="col-md-12 margin-bottom-15">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td><a href="#" class="btn btn-primary">Eliminar Historial</a></td>
                            </tr>
