                ...
                <div class='container'>
                    <div class='card'>
                        <div class='card-header'>
                            <h1>Editar Historial De Compras</h1>
                        </div>
                        <form action="" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 margin-bottom-15">
                                    <label for="lblNombre" class="control-label">Producto</label>
                                    <input type="text" class="form-control" id="txtProducto" name="txtProducto"
                                       >
                                </div>
                                <div class="col-md-1 margin-bottom-15"></div>
                                <div class="col-md-3 margin-bottom-15">
                                    <label for="lblApellido" class="control-label">Fecha De Compra</label>
                                    <input type="text" class="form-control" id="txtFechaCompra" name="txtApellido"
                                       >
                                </div>
                                <div class="col-md-1 margin-bottom-15"></div>
                            </div>
                            <div class="row">
                                <div class="col-md-1 margin-bottom-15"></div>
                                <div class="col-md-3 margin-bottom-15">
                                    <label for="lblCorreo" class="control-label">Precio</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 margin-bottom-15">
                                    ...
                                    <a href="dashHistorial.blade.php"><button type="button"class="btn btn-danger" style="margin-bottom: 18px;">Cancelar</button></a>
                                </div>
                            </div>
                        </form>
            </div>
