 ...
 <head>
 <title>Macrobiótica &mdash; Vida Natural</title>
    <meta charset="utf-8">
             ...
             <div class='dashboard-content'>
                 <div class='container'>
                     <div class='card'>
                         ...
                         <br>
                         <a href="AgregarCategoria.blade.php" class="btn btn-primary px-5 py-3" style="width: 20%; margin-left:40%;margin-top: 10px; margin-bottom: 10px;">Agregar categoria</a>
                         <a href="EditarCategoria.blade.php" class="btn btn-primary px-5 py-3" style="width: 20%; margin-left:40%; margin-top: 10px; margin-bottom: 10px;">Editar categoria</a>
                         <div class='card-body'>
                    ...
                    <div class="col-md-12 margin-bottom-15">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <td></td>
                                ...
                                <td></td>
                                <td></td>
                                <td><a href="#" class="btn btn-primary">Eliminar Categoria</a></td>
                            </tbody>
                        </table>
